  ...
  return (
    <>
      {isOpen && (
        <div
          role="presentation"
          className="fixed inset-0 bg-surface-900/30 z-40 lg:hidden"
          onClick={onClose}
        />
      )}
      <aside
        className={`
          fixed top-16 left-0 z-40 h-[calc(100vh-4rem)] w-64 bg-white border-r border-surface-200
        ...
        <nav className="p-4 space-y-0.5 overflow-y-auto h-full">
          {filteredItems.map((item) => {
            ...
            return (
              ...
              >
                <span className={active ? 'text-primary-800' : 'text-surface-500'}>
                  {item.icon}
                </span>
